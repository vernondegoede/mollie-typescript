 ...
 */
export async function paymentLinksAPICreatePaymentLink(
  client: MollieCore,
  ...
  Result<
    void,
    | errors.CreatePaymentLinkResponseBody
    | errors.CreatePaymentLinkPaymentLinksAPIResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePaymentLinkRequestBody$outboundSchema.optional().parse(
        value,
      ),
  ...
  >(
    M.nil(201, z.void()),
    M.jsonErr(404, errors.CreatePaymentLinkResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(
      422,
      errors.CreatePaymentLinkPaymentLinksAPIResponseBody$inboundSchema,
      { ctype: "application/hal+json" },
    ),
    M.fail(["4XX", "5XX"]),
