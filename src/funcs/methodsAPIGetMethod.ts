 ...
 */
export async function methodsAPIGetMethod(
  client: MollieCore,
  request: operations.GetMethodRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.GetMethodResponseBody,
    | errors.GetMethodResponseBody
    | errors.GetMethodMethodsAPIResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetMethodResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(400, errors.GetMethodResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.GetMethodMethodsAPIResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail(["4XX", "5XX"]),
