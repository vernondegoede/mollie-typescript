 ...
 */
export async function capturesAPICreateCapture(
  client: MollieCore,
  ...
  Result<
    void,
    | errors.CreateCaptureResponseBody
    | errors.CreateCaptureCapturesAPIResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.nil(201, z.void()),
    M.jsonErr(404, errors.CreateCaptureResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(422, errors.CreateCaptureCapturesAPIResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail(["4XX", "5XX"]),
