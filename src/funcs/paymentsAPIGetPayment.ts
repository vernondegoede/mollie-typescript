 ...
 */
export async function paymentsAPIGetPayment(
  client: MollieCore,
  request: operations.GetPaymentRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.GetPaymentResponseBody,
    | errors.GetPaymentResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.GetPaymentResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.GetPaymentResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail(["4XX", "5XX"]),
