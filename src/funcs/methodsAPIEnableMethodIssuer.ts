 ...
 */
export async function methodsAPIEnableMethodIssuer(
  client: MollieCore,
  request: operations.EnableMethodIssuerRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.EnableMethodIssuerResponseBody,
    | errors.EnableMethodIssuerResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.EnableMethodIssuerResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(404, errors.EnableMethodIssuerResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail(["4XX", "5XX"]),
