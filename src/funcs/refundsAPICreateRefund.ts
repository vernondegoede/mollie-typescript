 ...
 */
export async function refundsAPICreateRefund(
  client: MollieCore,
  ...
  Result<
    void,
    | errors.CreateRefundResponseBody
    | errors.CreateRefundRefundsAPIResponseBody
    | errors.CreateRefundRefundsAPIResponseResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    M.nil(201, z.void()),
    M.jsonErr(404, errors.CreateRefundResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(409, errors.CreateRefundRefundsAPIResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(
      422,
      errors.CreateRefundRefundsAPIResponseResponseBody$inboundSchema,
      { ctype: "application/hal+json" },
    ),
    M.fail(["4XX", "5XX"]),
