 ...
 */
export async function paymentsAPICancelPayment(
  client: MollieCore,
  ...
  Result<
    void,
    | errors.CancelPaymentResponseBody
    | errors.CancelPaymentPaymentsAPIResponseBody
    | SDKError
    | SDKValidationError
    | UnexpectedClientError
    | InvalidRequestError
...
> {
  ...
  >(
    ...
    M.jsonErr(404, errors.CancelPaymentResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.jsonErr(422, errors.CancelPaymentPaymentsAPIResponseBody$inboundSchema, {
      ctype: "application/hal+json",
    }),
    M.fail(["4XX", "5XX"]),
